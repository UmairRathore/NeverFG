...
Route::get('/edit-memorial-profile/{id}',[ProfileController::class,'index'])->name('edit.memorial.profile');
Route::post('/update-memorial-profile/{id}',[ProfileController::class,'update'])->name('update.memorial.profile');
