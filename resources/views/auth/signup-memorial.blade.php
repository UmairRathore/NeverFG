...
<form method="POST" action="{{ route('memorialregistration') }}" enctype="multipart/form-data">
    ...
    <section>
        ...
        <div class="user-img-container">
            <img id="previewImage" src="{{ asset('assets/images/blacklogo.jpg') }}" alt="" class="user-avatar">
            <label for="memorial_image" class="input-file-type-design">
                Add a photo
                <input id="memorial_image" type="file" name="memorial_image" onchange="previewSelectedImage(event)"/>
            </label>
        </div>
