                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb ps-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Frontend Features</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="ms-panel">
                        ...
                        <div class="ms-panel-body">
                            ...
                            @endif
                                ...
                                <form method="POST" action="{{ route('frontend_feature.update', $features->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="frontend_feature_title" class="form-control @error('frontend_feature_title') is-invalid @enderror" value="{{ $features->frontend_feature_title }}" placeholder="Enter Title">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <textarea name="frontend_feature_description" class="form-control @error('frontend_feature_description') is-invalid @enderror" placeholder="Enter Description">{{ $features->frontend_feature_description }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span id="featureImageFileName">{{ $features->frontend_feature_image }}</span>
                                            </div>
                                        </div>
                                    </div>
