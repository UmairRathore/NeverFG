                ...
                <div class="col-md-12">
                    ...
                    <div class="ms-panel">
                        <div class="ms-panel-header ms-panel-custome">
                            <h6>Feature List</h6>
                            <a href="{{route('frontend_feature.create')}}" class="btn btn-primary">Add Feature  </a>
                        </div>
                                ...
                                <table id="featurelist" class="table table-striped thead-primary w-100">
                                    ...
                                    @foreach ($features as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="fas fa-pencil alt" href="{{ route('frontend_feature.edit',$item->id) }}">Edit Feature</a>
                                                <a class="fas fa-trash alt" href="{{ route('frontend_feature.destroy',$item->id) }}">Delete Feature</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
